    ...
    def __init__(self,
        ...
        Args:
          ...
          max_position_embeddings: The maximum sequence length that this model
            might ever be used with. Typically set this to something large just
...
class BertModel(object):
    ...
    def __init__(self,
        ...
        Args:
          ...
          is_training: bool. rue for training model, false for eval model.
          ...
          use_one_hot_embeddings: (optional) bool. Whether to use one-hot word
            ...
            the TPU, it is must faster if this is True, on the CPU or GPU, it
            is faster if this is False.
